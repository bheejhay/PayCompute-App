...
namespace PayComputeApp.Persistence.Migrations
{
    ...
    [Migration("20200608142607_initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayComputeApp.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComputeApp.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComputeApp.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PayComputeApp.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayComputeApp.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayComputeApp.Entity.TaxYear", "TaxYear")
                        .WithMany()
